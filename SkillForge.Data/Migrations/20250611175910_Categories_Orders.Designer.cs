...
namespace SkillForge.Data.Migrations
{
    ...
    [Migration("20250611175910_Categories_Orders")]
    partial class Categories_Orders
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkillForge.Data.Entities.Category", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SkillForge.Data.Entities.Order", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SkillForge.Data.Entities.OrderItem", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SkillForge.Data.Entities.OrderItem", b =>
                {
                    b.HasOne("SkillForge.Data.Entities.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("SkillForge.Data.Entities.Product", b =>
                {
                    b.HasOne("SkillForge.Data.Entities.Category", "Category")
                        .WithMany()
